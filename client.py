...
connect_button = tkinter.Button(info_frame, text="Connect", font=my_font,
                                bg=light_green, borderwidth=5, width=10, command=connect)
disconnect_button = tkinter.Button(info_frame, text="Disconnect", font=my_font,
                                   bg=light_red, borderwidth=5, width=10, state=DISABLED, command=disconnect)
...
my_listbox = tkinter.Listbox(output_frame, height=20, width=55, borderwidth=3,
...
send_button = tkinter.Button(input_frame, text="send", borderwidth=5, width=10,
                             font=my_font, bg=light_green, state=DISABLED, command=send_message)
